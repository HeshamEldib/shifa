...
function ReportsPanel({ timeMode, frame, appointments, onGoAppointments }) {
  ...
  const [focus, setFocus] = useState("summary"); // summary | pending
  ...
  const exportCSV = () => {
    ...
    a.href = url;
    a.download = `shifaa_report_${timeMode}_${range}.csv`;
      ...
      <section className="cc-card">
        <div className="cc-cardHeadRow">
          <div>
            ...
            <div className="cc-cardSub">
              KPIs · Trends (Area + Line) · Drill‑down · Export
            </div>
          </div>
        ...
        <div className="cc-grid4">
          <article
            className="cc-card cc-stat cc-tone-blue"
            style={{ padding: 12 }}
          >
          ...
          <article
            className="cc-card cc-stat cc-tone-amber"
            style={{ padding: 12 }}
          >
          ...
          <article
            className="cc-card cc-stat cc-tone-green"
            style={{ padding: 12 }}
          >
          ...
          <article
            className="cc-card cc-stat cc-tone-violet"
            style={{ padding: 12 }}
          >
            ...
            <div className="cc-cardSub">
              Cancelled ÷ total (demo)
            </div>
          </article>
        </div>
      </section>

      {/* Charts row (Area + Line) */}
      <section className="cc-grid2">
        <article className="cc-card">
          <div className="cc-cardTitle">
          ...
          <div className="cc-cardSub">
            7‑day trend (demo) · {frame.label}
          </div>

          <div
            style={{ width: "100%", height: 280, marginTop: 10 }}
          >
            <ResponsiveContainer>
        ...
        <article className="cc-card">
          ...
          <div className="cc-cardSub">
            Pending per day (demo) · {frame.label}
          </div>
      ...
      {focus === "pending" && (
        <section className="cc-card">
          <div className="cc-cardHeadRow">
            <div>
              <div className="cc-cardTitle">
                Pending appointments (Drill‑down)
              </div>
              <div className="cc-cardSub">
                Resolve them in management
              </div>
            </div>
            <button
              className="cc-btn"
